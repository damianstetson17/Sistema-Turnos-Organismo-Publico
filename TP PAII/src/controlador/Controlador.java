        ...
        if(empleado!=null)
        {
            if(turnos!=null)
            {
                for(Turno turno: turnos){
                    if(turno.getEstado().getNombreEstado().equals("en espera") ||turno.getEstado().getNombreEstado().equals("atendiendo") ||turno.getEstado().getNombreEstado().equals("para atencion")){
                 ...
                 throw new NotificarError("No se encontraron Turnos pendientes para atender ");
                 
            }
            
        } else{
                 throw new NotificarError("No se encontro el empleado");
            }
        return turnospendientes;   
    }    
...
//////////////////////////////////////// METODOS CREAR ////////////////////////////////////////////
    ...
    public void crearUnTramite(Integer nroTramiteAgregar, String nombreTramiteAgregar,String nombreTipoTramiteAsignar,List<Requisito> requisitosObli)throws NotificarError{
		...
		if (duplicado != null) {
			 ...
			 */
			mensaje = String.format("Ya existe el Tramite: %s.", tramiteAAgregar.getNombreTramite());
			throw new NotificarError(mensaje);
		}
    ...
    public void crearUnSupervisor(String nombreAgregar, String apellidoAgregar, long dniAgregar,String nombreArea)throws NotificarError {
		...
		if (duplicado != null) {
			 ...
			 */
			mensaje = String.format("Ya existe el Supervisor: %s.", supervisorAAgregar.getNombre());
			throw new NotificarError(mensaje);
		}
