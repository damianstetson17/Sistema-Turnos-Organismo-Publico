...
public class ListTramiteporArea extends javax.swing.JFrame {
    ...
    /**
     * CARGAR EL COMBOBOX CON LOS DATOS DE LA BD
     */
    ...
    /**
     * CARGAR EL JTABLE  CON LA BD
     * @param nombreAreaABuscar
     ...
     */
     private void mostrarTablaTramitePorArea(String nombreAreaABuscar) throws NotificarError{
        ...
        List<Tramite> tramites= controlador.buscarTramitesRealizadosDeUnArea(nombreAreaABuscar);
        if(!tramites.isEmpty()){
            int i=0;
            ...
            JOptionPane.showMessageDialog(null, "No existen Tramites realizados en el area ingresada.");
            setVisible(true);
           PanelInicioListadoTramite.setVisible(true);
           PanelListaTramite.setVisible(false);
    ...
    */
    ...
    /**
     * ACCIONES DEL BOTON SALIR DEL PANEL 1
     * @param evt 
     */
    ...
    /**
     * ACCIONES DEL BOTON SALIR DEL PANEL 2 
     * @param evt 
     */
