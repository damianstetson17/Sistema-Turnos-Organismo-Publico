...
//TODO turno
    private void mostrarTablaTurnosPendientes(long dni) throws NotificarError{
       ...
       turnos= controlador.obtenerTurnosPendientesAtenderEmpleado(dni);
...
//botones
    private void btnReasignarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReasignarActionPerformed
        ...
        if(confirmar.equals("si")&& !NroTurnoAReasignar.getText().equals("")){
            ...
            JOptionPane.showMessageDialog(null,"Debe completar todos los  para continuar");   
        }     
