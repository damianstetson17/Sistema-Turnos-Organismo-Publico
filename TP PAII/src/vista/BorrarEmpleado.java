...
public class BorrarEmpleado extends javax.swing.JFrame {
    ...
    public BorrarEmpleado(Controlador controlador) {
        initComponents();
        setVisible(true);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Nombre empleado a borrar:");
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        if((confirmado==true)&&(!(nombreborrar.getText().equals("")))){
            try {
                Empleado empleadoABorrar= controlador.buscarUnEmpleado(dni);
                if(empleadoABorrar!=null){
                    controlador.BorrarEmpleado(empleadoABorrar);
                    JOptionPane.showMessageDialog(null,"Se borro el Empleado "+empleadoABorrar.getNombre()+ " "+empleadoABorrar.getApellido());
                    dispose();
