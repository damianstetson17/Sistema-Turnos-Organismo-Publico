...
public class BorrarPrioridad extends javax.swing.JFrame {

    private Controlador controlador;
    private boolean confirmado=false;
    private String nombre;
    public BorrarPrioridad(Controlador controlador) {
        initComponents();
        setVisible(true);
        this.controlador=controlador;
        setTitle("Borrar Prioridad");
        setSize(800, 650);
    ...
    private void mostrarTablaNombres() throws NotificarError{
        ...
        if(!prioridades.isEmpty()){
             for(Prioridad e: controlador.buscarPrioridades()){
            matriz[i][0]=e.getNombrePrioridad();
             matriz[i][1]=String.valueOf(e.getNivelPrioridad());
            i++;
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Prioridades existentes:");
        ...
        jLabel2.setText("Nombre Prioridad a borrar:");
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        if((confirmado==true)&&(!(nombreborrar.getText().equals("")))){
            try {
                Prioridad prioridadBorrar= controlador.buscarUnaPrioridad(nombre);
                if(prioridadBorrar!=null){
                    controlador.BorrarPrioridad(prioridadBorrar);
                    JOptionPane.showMessageDialog(null,"Se borro la Prioridad "+prioridadBorrar.getNombrePrioridad());
                    dispose();
