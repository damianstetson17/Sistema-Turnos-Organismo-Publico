...
public class ListTipoTramitePorArea extends javax.swing.JFrame {
    ...
    /**
     * CARGAR EL COMBO CON DATOS DE LA BD
     */
    ...
    private void mostrarListaTipoTramiteRealizado() throws NotificarError{
        ...
        List<TipoTramite> tipotramite= controlador.tipoTramitesRealizadosPorArea(nombreAreaBuscar);
        if(!tipotramite.isEmpty()){
            int i=0;
            for(TipoTramite tt:  tipotramite){
            ...
            JOptionPane.showMessageDialog(null, "No existen Tipos Tramites realizados en el area ingresada.");
            TablaTipoTramite.setModel(new DefaultTableModel(
            null,
             new String [] {
                "Nombre"
    ...
    /**
     * ACCIONES DEL BOTON SALIR DEL PANEL INICIO
     * @param evt 
     */
