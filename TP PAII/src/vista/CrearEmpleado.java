...
/**
 * CARGA EL JTABLE DE EMPLEADOS EXISTENTES EN LA BD
                ...
                try {
                    ...
                    if((dni==0) || (10000000>dni)){
                        ...
                        if(areatrab==null){
                            ...
                            JOptionPane.showMessageDialog(null, "se creo el empleado "+nomb+ " "+ape);
                            dispose();
...
/**
 * CARGA EL COMBO CON TODAS LAS AREAS EXISTENTES
 */
