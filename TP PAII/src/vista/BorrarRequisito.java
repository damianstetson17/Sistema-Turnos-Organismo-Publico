...
public class BorrarRequisito extends javax.swing.JFrame {

    private Controlador controlador;
    private boolean confirmado=false;
    private String nombre;
    public BorrarRequisito(Controlador controlador) {
        initComponents();
        setVisible(true);
        this.setLocationRelativeTo(null);
        this.setResizable(false);
        this.controlador=controlador;
        setTitle("Borrar Requisito");
        setSize(800, 650);
    ...
    private void mostrarTablaNombres() throws NotificarError{
        ...
        if(!requisitos.isEmpty()){
             for(Requisito e: controlador.buscarRequisitos()){
            matriz[i][0]=e.getNombreRequisito();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Requisitos existentes:");
        ...
        jLabel2.setText("Nombre Requisito a borrar:");
    ...
    private void TablaNombreMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaNombreMouseClicked
        ...
        if(row>=0){
            ...
            if(nombre.equals("")){
                JOptionPane.showMessageDialog(null, "Debe seleccionar un Requisito.");
                setVisible(true);
            }else{
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        if((confirmado==true)&&(!(nombreborrar.getText().equals("")))){
            try {
                Requisito requisitoABorrar= controlador.buscarRequisito(nombre);
                if(requisitoABorrar!=null){
                    controlador.BorrarRequisito(requisitoABorrar);
                    JOptionPane.showMessageDialog(null,"Se borro el Requisito "+requisitoABorrar.getNombreRequisito());
                    dispose();
